...
export function ClientFormModal({ org, onClose }: Props) {
  ...
  return (
    <FormModal title={isEdit ? 'Editar cliente' : 'Nuevo cliente'} onClose={onClose}>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {!isEdit ? (
          <div>
            <label className="mb-1 block text-sm font-medium text-gray-700">
              Usuario administrador <span className="text-red-500">*</span>
            </label>
            <select
